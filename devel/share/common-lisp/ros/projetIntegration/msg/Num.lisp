...
(cl:in-package projetIntegration-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <Num>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Num)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name projetIntegration-msg:<Num> is deprecated: use projetIntegration-msg:Num instead.")))

(cl:ensure-generic-function 'num-val :lambda-list '(m))
(cl:defmethod num-val ((m <Num>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader projetIntegration-msg:num-val is deprecated.  Use projetIntegration-msg:num instead.")
  (num m))
